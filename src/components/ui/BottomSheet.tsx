      ...
      style={
        {
            ...
            // Потолок высоты шторки: резерв сверху 160px (подбирается эмпирически
            // под шапку Telegram на iPhone: 64/96 — мало, 192 — много), минус высота
            ...
            maxHeight: 'calc(var(--tg-viewport-stable-height, 100dvh) - max(160px, var(--tg-content-safe-top, 0px)) - var(--kb-ride, 0px))',
