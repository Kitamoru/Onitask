  ...
  public: {
    Tables: {
      ...
      bot_review_fix_pending: {
        ...
        Relationships: [
          {
            foreignKeyName: "bot_review_fix_pending_task_id_fkey"
            columns: ["task_id"]
            isOneToOne: true
            referencedRelation: "duplicate_tasks"
            referencedColumns: ["task1_id"]
          ...
          {
            foreignKeyName: "bot_review_fix_pending_workspace_id_fkey"
            columns: ["workspace_id"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
      ...
      bot_task_drafts: {
        ...
        Relationships: [
          {
            foreignKeyName: "bot_task_drafts_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
      ...
      dispatch_outbox: {
        ...
        Relationships: [
          {
            foreignKeyName: "dispatch_outbox_task_id_fkey"
            columns: ["task_id"]
            isOneToOne: false
            referencedRelation: "duplicate_tasks"
            referencedColumns: ["task1_id"]
          ...
          {
            foreignKeyName: "dispatch_outbox_workspace_id_fkey"
            columns: ["workspace_id"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
      ...
      dispatch_receipts: {
        ...
        Relationships: [
          {
            foreignKeyName: "dispatch_receipts_execution_id_fkey"
          ...
          {
            foreignKeyName: "dispatch_receipts_outbox_id_fkey"
            columns: ["outbox_id"]
            isOneToOne: false
            referencedRelation: "dispatch_outbox"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      task_executions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "task_executions_workspace_id_fkey"
            columns: ["workspace_id"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
      ...
      task_submissions: {
        ...
        Relationships: [
          {
            foreignKeyName: "task_submissions_accepted_by_fkey"
            columns: ["accepted_by"]
            isOneToOne: false
            referencedRelation: "attention_risk_pulse"
            referencedColumns: ["worker_id"]
          ...
          {
            foreignKeyName: "task_submissions_workspace_id_fkey"
            columns: ["workspace_id"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
      ...
      tasks: {
        ...
        Relationships: [
          {
            foreignKeyName: "tasks_active_claim_id_fkey"
      ...
      telegram_message_queue: {
        ...
        Relationships: [
          {
            foreignKeyName: "telegram_message_queue_workspace_id_fkey"
            columns: ["workspace_id"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
      ...
      workspace_settings: {
        Row: {
          agent_quotas: Json
          ai_mutations_per_day: number | null
    ...
    Functions: {
      ...
      check_and_decrement_quota: {
        Args: { p_agent_name: string; p_cost?: number; p_workspace_id: string }
        Returns: Json
      }
      consume_bot_task_draft: {
      ...
      create_invite_link: {
        Args: { p_code: string; p_created_by: string; p_workspace_id: string }
        Returns: {
          code: string
          invite_id: string
        }[]
      ...
      gc_bot_review_fix_pending: { Args: { p_batch?: number }; Returns: number }
      gc_consolidation_errors: { Args: { p_batch?: number }; Returns: number }
      gc_enrichment_queue_failed: {
        Args: { p_batch?: number }
        Returns: number
      }
      gc_ops_history: { Args: { p_batch?: number }; Returns: number }
      gc_orphan_task_attachments: {
        Args: { p_batch?: number }
        Returns: number
      }
      gc_task_events: { Args: { p_batch?: number }; Returns: number }
      gc_telegram_message_queue: { Args: { p_batch?: number }; Returns: number }
      get_bot_notify_cron_secret: { Args: never; Returns: string }
      get_edge_fn_url: { Args: never; Returns: string }
      get_my_workspace_ids: { Args: never; Returns: string[] }
      get_task_card_data: { Args: { p_task_id: string }; Returns: Json }
      get_task_card_data_by_full_id: {
        Args: { p_full_id: string }
        Returns: Json
      }
      get_task_feed: {
        Args: {
      ...
      get_workspace_operational_context: {
      ...
      ops_ensure_worker: {
        Args: { p_agent_name: string; p_workspace_id: string }
        Returns: string
      }
      ops_error: {
      ...
      ops_heartbeat: {
        Args: { p_execution_id: string; p_runtime_id: string }
        Returns: Json
      }
      ops_lease: {
        Args: {
      ...
      ops_publisher_tick: { Args: { p_batch?: number }; Returns: undefined }
      ops_reaper_tick: { Args: { p_batch?: number }; Returns: number }
      ops_terminal: {
        Args: {
          p_execution_id: string
          p_metadata?: Json
          ...
          p_summary?: string
          p_task_id: string
          p_task_version: number
        }
        Returns: Json
      }
      purge_expired_bot_attach_pending: { Args: never; Returns: undefined }
      purge_expired_bot_task_drafts: { Args: never; Returns: undefined }
      review_action: {
        Args: {
          p_action: string
      ...
      transfer_workspace_ownership: {
        Args: { p_to_worker_id: string; p_workspace_id: string }
        Returns: undefined
      }
    }
    Enums: {
