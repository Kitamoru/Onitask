-- ============================================================================
-- 094_fix_invite_redemption_conflict.sql
-- Fix an ambiguous ON CONFLICT column reference in the transactional
-- invite-redemption RPC (the output column workspace_id shadowed the table column).
